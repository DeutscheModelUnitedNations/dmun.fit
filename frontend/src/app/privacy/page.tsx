  ...
  return <>
    <Content>
      ...
      <div id="policy">
        ...
        <h2>Contact Us</h2>
        <P>If you have any questions or suggestions about the Privacy Policy, do not hesitate to contact us at <a href="mailto:contact@dmun.fit">contact@dmun.fit</a>.</P>
      </div>
    </Content>
